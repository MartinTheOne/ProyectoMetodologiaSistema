        ...
        <>
            ...
            <div className="flex justify-center mt-[100px] mb-20">
                <div class="flex items-center w-[600px] movil-sm:w-[400px] movil-s:w-[400px] movil-m:w-[500px] justify-center p-4">
                    <div class=" bg-[#1e5e39] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        ...
                        <div class="p-6 space-y-4 movil-sm:space-y-4 font-julius text-[#0E3C09]">
                            <h2 class="text-2xl font-bold text-[#e0e0e0] hover:text-gray-600 transition-colors duration-300" tabindex="0">Lic. Lopez Ana</h2>
                            <div class="flex items-center space-x-1" aria-label="5 out of 5 stars rating">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 bg-[#1e5e39] transition-transform hover:scale-110" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="flex items-start space-x-2">
                                ...
                                <p class="text-[#e0e0e0]">24 de septiembre 109</p>
                            </div>
                            <div class="flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6  flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p class="text-[#e0e0e0]">Primera consulta: <span class="  rounded-lg px-[1px] py-1 "> <span className=''>Gratis</span></span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex justify-center mb-[50px] ">
                <h2 className="font-julius text-[#e0e0e0] text-4xl font-extrabold border-b-2 border-b-[#276943]" >
                    Turnos
                </h2>
            </div>
            ...
            <div className="flex flex-col items-center gap-10">
                ...
                <div className="Lunes">
                    ...
                    <div class="p-4 flex items-center justify-center">
                        ...
                        <div class="h-[150px] w-[600px] movil-sm:w-[350px] movil-s:w-[400px] movil-m:w-[500px] mt-4 font-julius bg-[#1e5e39] rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 space-y-4" role="region" aria-label="Selector de turnos">

                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">

                                <div class="space-y-1">
                                    <h2 class="text-2xl font-semibold text-[#e0e0e0] ">Lunes</h2>
                ...
                <div className="Miercoles">
                    <div class="h-[150px] w-[600px] movil-sm:w-[350px] movil-s:w-[400px] movil-m:w-[500px]  font-julius bg-[#1e5e39] rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 space-y-4" role="region" aria-label="Selector de turnos">

                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">

                            <div class="space-y-1">
                                <h2 class="text-2xl font-semibold text-[#e0e0e0] ">Miercoles</h2>
                ...
                <div className="Viernes">
                    <div class="h-[150px] w-[600px] movil-sm:w-[350px] movil-s:w-[400px] movil-m:w-[500px] mt-4 font-julius bg-[#1e5e39] rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 space-y-4" role="region" aria-label="Selector de turnos">
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div class="space-y-1">
                                <h2 class="text-2xl font-semibold text-[#e0e0e0] ">Viernes</h2>
