    ...
    return (
        <>
            ...
            <div className="flex justify-center mt-[100px] mb-20">
                <div class="flex items-center w-[600px] justify-center p-4">
                    <div class=" bg-[#6cb472] rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        <div class="relative">
                            <img className='w-full' src="/img/Nutri.webp"/>
                                <div class="absolute top-0 right-0 m-4 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold">Gratis</div>
                        </div>
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex items-center space-x-1" aria-label="5 out of 5 stars rating">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-yellow-400 transition-transform hover:scale-110" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div class="flex items-start space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <p class="text-gray-600">24 de septiembre 109</p>
                            </div>
                            <div class="flex items-center space-x-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <p class="text-gray-600">Primera consulta: <span class="font-semibold bg-green-800 rounded-lg px-2 py-1 "> <span className='text-green-500'>Gratis</span></span></p>
                            </div>
                        </div>
                    </div>
                </div>
