  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-[100px] movil-sm:mt-[60px] ">
        <h2 className='font-julius text-[#e0e0e0] text-6xl 700-md:text-6xl movil-m:text-[50px] movil-s:text-[44px] movil-sm:text-[30px]  font-extrabold'>
          Sobre Nosotros
        </h2>
      </div>

      <div className="flex justify-center mt-[100px] movil-s:mt-[60px] movil-sm:mt-[60px] mb-10">
        <p className='font-julius text-[#e0e0e0]  text-3xl 700-md:text-[26px] movil-m:text-[22px] movil-s:text-[18px] movil-sm:text-[16px] movil-smm:text-[12px] font-extrabold'>
      ...
      <div id='Texto descriptivo' className="h-[90px] w-[896px] mb-20 700-md:h-[110px] 700-md:max-w-2xl movil-m:h-[110px] movil-m:w-[500px] movil-s:h-[110px] movil-s:w-[500px] movil-sm:h-[110px] movil-sm:w-[400px] movil-smm:max-w-[300px] movil-smm:h-[170px] shadow-lg rounded-lg bg-[#1e5e39]">
           <h2 className='text-center mt-4 text-xl font-julius movil-m:text-[20px] movil-s:text-[18px] movil-sm:text-[16px] text-[#e0e0e0]'>
                Contamos con tres locales, dos en San miguel y uno en Yerba Buena <br />¿Que esperas para acercarte a conocerlos?
          </h2>
      </div>

      <p className='font-julius mb-10 text-[#e0e0e0] text-4xl movil-m: movil-s:text-[30px] movil-sm:text-[26px] movil-smm:text-[20px] font-extrabold'>
